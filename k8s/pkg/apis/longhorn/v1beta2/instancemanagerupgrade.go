...
const (
	InstanceManagerUpgradeStatePending                  = "pending"
	InstanceManagerUpgradeStateRelocatingEngines        = "relocating-engines"
	InstanceManagerUpgradeStateWaitingForSourceIM       = "waiting-for-source-im"
	InstanceManagerUpgradeStateRestoringEngines         = "restoring-engines"
	InstanceManagerUpgradeStateWaitingForHealthyVolumes = "waiting-for-healthy-volumes"
	InstanceManagerUpgradeStateCompleted                = "completed"
	InstanceManagerUpgradeStateFailed                   = "failed"
)
